        ...
        prepareSlides = function(e, t) {
            ...
            e.parent().css({
                ...
                n.addClass("defaultvid").css({
                    zIndex: 30
                }), i.addClass("defaultimg"), "on" == t.fallbacks.panZoomDisableOnMobile && _ISM && (i.data("kenburns", "off"), i.data("bgfit", "contain")), i.wrap('<div class="slotholder" style="position:absolute; top:0px; left:0px; z-index:0;width:100%;height:100%;"></div>'), n.appendTo(i.closest("li").find(".slotholder"));
                var a = i.data();
                ...
                var r = i.attr("src");
                a.src = r, a.bgfit = a.bgfit || "contain", a.bgrepeat = a.bgrepeat || "no-repeat", a.bgposition = a.bgposition || "center center";
